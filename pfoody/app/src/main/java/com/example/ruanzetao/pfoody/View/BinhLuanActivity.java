...
import com.example.ruanzetao.pfoody.Adapters.AdapterHienThiHinhBinhLuanDuocChon;
import com.example.ruanzetao.pfoody.Controller.BinhLuanController;
    ...
    public void onClick(View v) {
        ...
        switch (id){
            ...
            case R.id.txtDangBinhLuan:
                ...
                binhLuanModel.setMauser(Long.parseLong(mauser));
